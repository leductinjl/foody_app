...
import { Dispatch } from 'redux'; // Add this import
...
const BookmarkCard: React.FC<Props> = ({ id, name, images, location, tags, navigate }) => {
  const dispatch: Dispatch<any> = useDispatch(); // Specify Dispatch type here
        ...
        <View style={styles.buttonLabelRow}>
          ...
          <View style={styles.rowAndCenter}>
            <Ionicons
              ...
              size={15}
            />
            <Text style={styles.ratingText}>20 phút</Text>
          </View>
          <View style={styles.rowAndCenter}>
            <Ionicons
