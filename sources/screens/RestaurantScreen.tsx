...
const RestaurantScreen = ({ navigation, route: { params: { restaurantId } } }: RestaurantScreenProps) => {
  ...
  const isBookmarked = useSelector(
    (state: any) =>
      state?.bookmarkState?.bookmarks?.some(
        (item: { restaurantId: string }) => item?.restaurantId === restaurantId,
      ),
  );

  const addBookmark = () =>
    dispatch<any>(BookmarkAction.addBookmark({ restaurantId }));
  const removeBookmark = () =>
    dispatch<any>(BookmarkAction.removeBookmark({ restaurantId }));
          ...
          <View style={styles.mainContainer}>
            ...
            <View style={styles.deliveryDetailsContainer}>
              ...
              <View style={styles.rowAndCenter}>
                ...
                />
                <Text style={styles.deliveryDetailText}>
                  {restaurant?.distance ? restaurant.distance / 1000 : 0}km
                </Text>
              </View>
